...
complete -c pkgfile -s 'R' -l 'repo' -d 'search only in the specified repository'
complete -c pkgfile -s 'v' -l 'verbose' -d 'enable verbose output'
complete -c pkgfile -s 'i' -l 'info' -d 'provides information about the package owning a file'
complete -c pkgfile -s 'l' -l 'list' -d 'list files of a given package; similar to "pacman -Ql"'
complete -c pkgfile -s 's' -l 'search' -d 'search which package owns a file'
