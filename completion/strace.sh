...
complete -c strace -s 'p' -l 'attach'
complete -c strace -s 'u' -l 'user'
...
complete -c strace -d 'Run tracer process as tracee'"'"'s grandchild in a separate process group.'
complete -c strace -d 'Run tracer process as tracee'"'"'s grandchild in a separate session'
complete -c strace -s 'f' -l 'follow-forks'
complete -c strace -l 'output-separately'
complete -c strace -d 'Like --follow-forks --output-separately'
...
complete -c strace -l 'absolute-timestamps' -d 'If given twice, the time printed will include the microseconds'
complete -c strace -l 'absolute-timestamps'
...
complete -c strace -d 'Print all strings in hex format'
complete -c strace -s 'X' -l 'const-print-style' -d 'Set the format for printing of named constants and flags'
complete -c strace -l 'decode-fds' -d 'Print all available information associated with file descriptors'
...
complete -c strace -s 'S' -l 'summary-sort-by' -d 'Sort summary by the specified criterion'
