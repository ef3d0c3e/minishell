...
complete -c xrandr -s 'd' -l 'display' -d 'Select X display to use'
complete -c xrandr -l 'screen' -d 'Select which screen to manipulate'
complete -c xrandr -l 'q1' -d 'Use RandR version 1.1 protocol'
complete -c xrandr -l 'q12' -d 'Use RandR version 1.2 protocol'
complete -c xrandr -s 's' -l 'size' -d 'Set the screen size (index or width x height)'
complete -c xrandr -s 'r' -l 'rate' -l 'refresh' -d 'Set the refresh rate closest to the specified value'
complete -c xrandr -s 'o' -l 'orientation' -d 'Specify the orientation of the screen'
...
complete -c xrandr -l 'setmonitor' -d 'Define new monitor'
complete -c xrandr -l 'delmonitor' -d 'Delete monitor'
...
complete -c xrandr -l 'panning' -d 'Set panning parameters'
complete -c xrandr -l 'transform' -d 'Set transformation matrix'
complete -c xrandr -l 'scale' -d 'Set screen scale'
complete -c xrandr -l 'primary' -d 'Set the output as primary'
complete -c xrandr -l 'filter' -d 'Set scaling filter method'
complete -c xrandr -l 'prop' -l 'properties' -d 'Display the contents of properties for each output'
complete -c xrandr -l 'fb' -d 'Set screen size'
complete -c xrandr -l 'fbmm' -d 'Set reported physical screen size'
complete -c xrandr -l 'dpi' -d 'Set dpi to calculate reported physical screen size'
complete -c xrandr -l 'newmode' -d 'Add new mode'
complete -c xrandr -l 'rmmode' -d 'Removes a mode from the server'
...
complete -c xrandr -l 'mode' -d 'This selects a mode'
complete -c xrandr -l 'preferred' -d 'Select the same mode as --auto, but it do not automatically enable or disable the output'
complete -c xrandr -l 'pos' -d 'Set output position within the secreen in pixels'
complete -c xrandr -l 'rate' -d 'Set refresh rate'
complete -c xrandr -l 'reflect' -d 'Set reflection'
complete -c xrandr -l 'rotate' -d 'Set rotation'
complete -c xrandr -l 'left-of' -d 'Set position relative to the output'
complete -c xrandr -l 'right-of' -d 'Set position relative to the output'
complete -c xrandr -l 'above' -d 'Set position relative to the output'
complete -c xrandr -l 'below' -d 'Set position relative to the output'
complete -c xrandr -l 'same-as' -d 'Set position relative to the output'
complete -c xrandr -l 'set' -d 'Set the property value: --set <prop> <value>'
complete -c xrandr -l 'off' -d 'Disables the output'
complete -c xrandr -l 'crtc' -d 'Set the crtc'
complete -c xrandr -l 'gamma' -d 'Set gamma correction [red:green:blue]'
