...
complete -c unzstd -l 'train' -d 'Create a dictionary from specified file(s)'
...
complete -c unzstd -s 'D' -d 'Use specified file as dictionary'
complete -c unzstd -s 'o' -d 'Specify file to save'
