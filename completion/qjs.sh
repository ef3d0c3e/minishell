...
complete -c qjs -l 'eval' -s 'e' -d 'evaluate EXPR'
...
complete -c qjs -l 'include' -s 'I' -d 'include an additional file'
...
complete -c qjs -l 'memory-limit' -d 'limit the memory usage to '"'"'n'"'"' bytes'
complete -c qjs -l 'stack-size' -d 'limit the stack size to '"'"'n'"'"' bytes'
