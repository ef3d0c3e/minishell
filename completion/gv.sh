...
complete -c gv -l 'arguments' -d 'Start ghostscript with additional options as specified by the string ARGS'
complete -c gv -l 'page' -d 'Display the page with label LABEL first'
...
complete -c gv -l 'orientation' -d 'Sets the orientation of the page'
complete -c gv -l 'scale' -d 'Selects the scale N, or arbitrary scale f.f'
complete -c gv -l 'scalebase' -d 'Selects the scale base N'
...
complete -c gv -d 'Set geometry'
complete -c gv -l 'ad' -d 'Read and use additional resources from FILE (higher priority)'
complete -c gv -l 'style' -d 'Read and use additional resources from FILE (lower priority)'
complete -c gv -l 'password' -d 'Sets the password for opening encrypted PDF files'
