...
complete -c tar -l 'hole-detection' -d 'Use  METHOD  to detect holes in sparse files'
...
complete -c tar -l 'group-map' -d 'Read group translation map from FILE'
...
complete -c tar -l 'owner-map' -d 'Read owner translation map from FILE'
...
complete -c tar -l 'sort' -d 'sort directory entries according to ORDER'
...
complete -c tar -s 'f' -l 'file' -d 'Archive file'
complete -c tar -l 'force-local' -d 'Archive file is local even if it has a colon'
complete -c tar -s 'F' -l 'info-script' -l 'new-volume-script' -d 'Run script at end of tape'
complete -c tar -s 'L' -l 'tape-length' -d 'Tape length'
complete -c tar -s 'M' -l 'multi-volume' -d 'Multi volume archive'
complete -c tar -l 'rmt-command' -d 'Use COMMAND instead of rmt'
complete -c tar -l 'rsh-command' -d 'Use COMMAND instead of rsh'
complete -c tar -l 'volno-file' -d 'keep track of which volume of a multi-volume archive it is working in FILE'
complete -c tar -s 'f' -l 'file' -d 'Archive file'
complete -c tar -s 'f' -l 'file' -d 'Archive file'
complete -c tar -s 'f' -l 'file' -d 'Archive file'
complete -c tar -s 'b' -l 'block-size' -d 'Block size'
complete -c tar -s 'B' -l 'read-full-blocks' -d 'Reblock while reading'
complete -c tar -s 'C' -l 'directory' -d 'Change directory'
...
complete -c tar -s 'K' -l 'starting-file' -d 'Starting file in archive'
...
complete -c tar -s 'N' -l 'after-date' -d 'Only store newer files'
complete -c tar -l 'newer' -d 'Only store newer files'
...
complete -c tar -s 'T' -l 'files-from' -d 'Extract file from file'
...
complete -c tar -s 'V' -l 'label' -d 'Set volume name'
complete -c tar -s 'w' -l 'interactive' -d 'Ask for confirmation'
complete -c tar -l 'confirmation' -d 'Ask for confirmation'
complete -c tar -l 'exclude' -d 'Exclude file'
complete -c tar -s 'X' -l 'exclude-from' -d 'Exclude files listed in specified file'
complete -c tar -s 'a' -l 'auto-compress' -d 'Use archive suffix to determine the compression program'
complete -c tar -s 'I' -l 'use-compress-program' -d 'Filter through specified program'
