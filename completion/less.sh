...
complete -c less -s 'b' -l 'buffers' -d 'Buffer space'
...
complete -c less -s 'h' -l 'max-back-scroll' -d 'Maximum backward scroll'
...
complete -c less -s 'j' -l 'jump-target' -d 'Target line'
complete -c less -s 'J' -l 'status-column' -d 'Display status column'
complete -c less -s 'k' -l 'lesskey-file' -d 'Specify key bindings binary file'
complete -c less -l 'lesskey-src' -d 'Specify key bindings source file'
...
complete -c less -l 'log-file' -d 'Log input to file'
complete -c less -l 'LOG-FILE' -d 'Log to file, overwrite'
complete -c less -l 'pattern' -d 'Start at first occurrence of pattern'
complete -c less -l 'prompt' -d 'Prompt string'
...
complete -c less -l 'tag' -d 'Edit tag'
complete -c less -l 'tag-file' -d 'Set tag file'
...
complete -c less -s 'x' -l 'tabs' -d 'Set tab stops'
complete -c less -s 'X' -l 'no-init' -d 'No termcap init'
complete -c less -l 'no-keypad' -d 'No keypad init'
complete -c less -s 'y' -l 'max-forw-scroll' -d 'Maximum forward scroll'
complete -c less -l 'window' -d 'Max scroll window'
complete -c less -s '"' -l 'quotes' -d 'Set quote char'
complete -c less -s '~' -l 'tilde' -d 'Lines after EOF are blank'
complete -c less -s '#' -l 'shift' -d 'Characters to scroll on left/right arrows'
