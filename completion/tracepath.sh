...
complete -c tracepath -s 'l' -d 'Sets the initial packet length'
complete -c tracepath -s 'm' -d 'Set maximum hops'
complete -c tracepath -s 'p' -d 'Sets the initial destination port'
