...
complete -c ncdu -s 'o' -d 'Export scanned directory'
complete -c ncdu -s 'f' -d 'Import scanned directory'
...
complete -c ncdu -l 'exclude' -d 'Exclude files that match pattern'
complete -c ncdu -s 'X' -l 'exclude-from' -d 'Exclude files that match any pattern in file'
...
complete -c ncdu -l 'color' -d 'Set color scheme'
...
complete -c ncdu -l 'graph-style' -d 'Relative size bar column style'
complete -c ncdu -l 'shared-column' -d 'Show/hide hard link shared sizes'
complete -c ncdu -l 'sort' -d 'Column to sort on'
