complete -c make -d 'Target'
complete -c make -d 'Target'
complete -c make -s 'f' -d 'Use file as makefile'
complete -c make -s 'C' -l 'directory' -d 'Change directory'
complete -c make -s 'd' -d 'Debug mode'
complete -c make -s 'e' -d 'Environment before makefile'
complete -c make -s 'i' -d 'Ignore errors'
complete -c make -s 'I' -d 'Search directory for makefile'
complete -c make -s 'j' -d 'Number of concurrent jobs (no argument means no limit)'
...
complete -c make -s 'o' -d 'Ignore specified file'
...
complete -c make -s 'W' -d 'Pretend file is modified'
