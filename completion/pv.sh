...
complete -c pv -l 'format' -s 'F' -d 'Set output format'
...
complete -c pv -l 'delay-start' -s 'D' -d 'Wait given time (in secs) before showing progress'
complete -c pv -l 'size' -s 's' -d 'Set total number of bytes to be transfered'
complete -c pv -l 'line-mode' -s 'l' -d 'Count lines instead of bytes'
complete -c pv -l 'null' -s '0' -d 'Count null-terminated lines'
complete -c pv -l 'interval' -s 'i' -d 'Wait given time (in secs) between updates'
complete -c pv -l 'width' -s 'w' -d 'Set terminal width'
complete -c pv -l 'height' -s 'H' -d 'Set terminal height'
complete -c pv -l 'name' -l 'N' -d 'Prefix output with given name'
complete -c pv -l 'force' -s 'f' -d 'Force output'
complete -c pv -l 'cursor' -s 'c' -d 'Use cursor positioning escape sequence instead of \r'
complete -c pv -l 'rate-limit' -s 'L' -d 'Limit transfer rate'
complete -c pv -l 'buffer-size' -s 'B' -d 'Use transfer buffer size (in bytes)'
...
complete -c pv -l 'watchfd' -s 'd' -d 'Watch file given description from given process (PID:FD)'
complete -c pv -l 'pidfile' -s 'P' -d 'Save pv PID in given file'
