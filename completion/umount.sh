complete -c umount -d 'Mount point'
...
complete -c umount -s 't' -l 'types' -d 'Actions should only be taken on file systems of the specified type'
complete -c umount -s 'O' -l 'test-opts' -d 'Actions should only be taken on file systems with the specified options in /etc/fstab'
