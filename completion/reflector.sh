...
complete -c reflector -l 'sort' -d 'Sort the mirrorlist'
...
complete -c reflector -s 'c' -l 'country' -d 'Restrict mirrors to selected countries'
...
complete -c reflector -s 'p' -l 'protocol' -d 'Match one of the given protocols'
