...
complete -c imv -s 'b' -d 'Background colour (6-digit hex)'
complete -c imv -s 'c' -d 'Command to run on launch'
...
complete -c imv -s 's' -d 'Set scaling mode to use'
complete -c imv -s 't' -d 'Slideshow mode with X seconds per photo'
complete -c imv -s 'u' -d 'Upscaling method'
