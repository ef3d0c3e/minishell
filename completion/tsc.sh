...
complete -c tsc -l 'lib' -d 'List of library files to be included in the compilation'
...
complete -c tsc -s 'm' -l 'module' -d 'Specify module code generation'
complete -c tsc -l 'moduleResolution' -d 'Determine how modules get resolved'
