complete -c black -s 'c' -l 'code' -d 'Format code passed in as a string'
complete -c black -s 'l' -l 'line-length' -d 'Characters per line'
complete -c black -s 't' -l 'target-version' -d 'Python versions supported by output'
...
complete -c black -l 'include' -d 'Regular expression of items to include'
complete -c black -l 'exclude' -d 'Regular expression of items to exclude'
complete -c black -l 'extend-exclude' -d 'Regular expression of additional items to exclude'
complete -c black -l 'force-exclude' -d 'Regular expression of Items to always exclude'
complete -c black -l 'stdin-filename' -d 'The name of the file when passing through stdin'
...
complete -c black -l 'config' -d 'Configuration file'
