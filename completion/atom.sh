...
complete -c atom -s 'l' -l 'log-file' -d 'Log all output to file'
complete -c atom -s 'n' -l 'new-window' -d 'Open a new window'
complete -c atom -l 'profile-startup' -d 'Profile startup execution time'
complete -c atom -s 'r' -l 'resource-path' -d 'Set Atom source directory and enable dev mode'
...
complete -c atom -l 'timeout' -d 'Set timeout for test mode (minutes)'
