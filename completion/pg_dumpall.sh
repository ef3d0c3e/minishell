complete -c pg_dumpall -s 'f' -l 'file' -d 'Output file name'
complete -c pg_dumpall -s 'v' -l 'verbose' -d 'Verbose mode'
complete -c pg_dumpall -s 'V' -l 'version' -d 'Output version information'
complete -c pg_dumpall -l 'lock-wait-timeout' -d 'Fail after waiting TIMEOUT for a table lock'
...
complete -c pg_dumpall -s 'E' -l 'encoding' -d 'Dump the data in encoding ENCODING'
...
complete -c pg_dumpall -s 'S' -l 'superuser' -d 'Superuser user name to use in the dump'
...
complete -c pg_dumpall -s 'd' -l 'dbname' -d 'Database to dump'
complete -c pg_dumpall -s 'h' -l 'host' -d 'Database server host or socket directory'
complete -c pg_dumpall -s 'l' -l 'database' -d 'Alternative default database'
complete -c pg_dumpall -s 'p' -l 'port' -d 'Database server port number'
complete -c pg_dumpall -s 'U' -l 'username' -d 'Connect as specified database user'
...
complete -c pg_dumpall -l 'role' -d 'Do SET ROLE before dump'
