...
complete -c zstdmt -l 'train' -d 'Create a dictionary from specified file(s)'
...
complete -c zstdmt -s 'D' -d 'Use specified file as dictionary'
complete -c zstdmt -l 'no-dictID' -d 'Do not write dictID into header'
complete -c zstdmt -s 'o' -d 'Specify file to save'
