...
complete -c totem -l 'enqueue' -d 'Tell any running totem instance: Add to playlist'
complete -c totem -l 'replace' -d 'Tell any running totem instance: Play from playlist'
