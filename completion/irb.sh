...
complete -c irb -s 'r' -d 'Load LIB using require'
complete -c irb -s 'I' -d 'Specify \$LOAD_PATH directory'
...
complete -c irb -s 'W' -d 'Set warning level'
complete -c irb -l 'context-mode' -d 'Create Binding Object'
...
complete -c irb -l 'prompt' -d 'Switch prompt mode'
...
complete -c irb -l 'back-trace-limit' -d 'Displays backtrace, top N and tail N'
complete -c irb -l 'irb_debug' -d 'Sets internal debug level to N'
