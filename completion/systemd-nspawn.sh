...
complete -c systemd-nspawn -l 'template' -d 'Directory or btrfs subvolume to use as template'
...
complete -c systemd-nspawn -s 'u' -l 'user' -d 'Change to user in the container'
...
complete -c systemd-nspawn -l 'network-macvlan' -d 'Create a "macvlan" interface of the specified Ethernet interface'
complete -c systemd-nspawn -l 'network-ipvlan' -d 'Create an "ipvlan" interface of the specified Ethernet interface'
complete -c systemd-nspawn -s 'n' -l 'network-veth' -d 'Create a virtual Ethernet link ("veth") between host and container'
complete -c systemd-nspawn -l 'network-bridge' -d 'Adds the host side of the Ethernet link created to the specified bridge'
complete -c systemd-nspawn -s 'p' -l 'port' -d 'Map an ip port from the host to the container'
...
complete -c systemd-nspawn -l 'link-journal' -d 'Set container journal visibility'
...
complete -c systemd-nspawn -l 'bind' -l 'bind-ro' -d 'Bind mount a file or directory from the host in the container'
complete -c systemd-nspawn -l 'tmpfs' -d 'Mount a tmpfs file system into the container'
complete -c systemd-nspawn -l 'overlay' -l 'overlay-ro' -d 'Mount directories as overlayfs in the container'
...
complete -c systemd-nspawn -l 'register' -d 'Register container with systemd-machined'
