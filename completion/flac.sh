...
complete -c flac -s 'o' -l 'output-name' -d 'Force the output file name'
...
complete -c flac -s 'T' -l 'tag' -d 'Add a Vorbis comment FIELD=VALUE; may appear multiple times'
complete -c flac -s 'T' -l 'tag-from-file' -d 'Read tags from file'
complete -c flac -s 'S' -l 'seekpoint' -d 'Add seek point(s) {#|X|#x|#s}'
complete -c flac -s 'P' -l 'padding' -d 'Write a PADDING block of length #'
...
complete -c flac -s 'b' -l 'blocksize' -d 'Specify blocksize in samples'
...
complete -c flac -s 'l' -l 'max-lpc-order' -d 'Max LPC order; 0 => only fixed predictors'
complete -c flac -s 'p' -l 'qlp-coeff-precision-search' -d 'Exhaustively search LP coeff quantization'
complete -c flac -s 'q' -l 'qlp-coeff-precision' -d 'Specify precision in bits'
complete -c flac -s 'r' -l 'rice-partition-order' -d 'Set [min,]max residual partition order'
