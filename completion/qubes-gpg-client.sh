...
complete -c qubes-gpg-client -s 'o' -l 'output' -d 'Write output to specified file'
...
complete -c qubes-gpg-client -l 'charset' -l 'display-charset' -d 'Set the native character set'
...
complete -c qubes-gpg-client -l 'command-fd' -d 'Read user input from specified file descriptor'
complete -c qubes-gpg-client -l 'comment' -d 'Use specified string as comment string'
...
complete -c qubes-gpg-client -l 'max-output' -d 'Sets a limit on the number of bytes that will be generated when processing a file'
...
complete -c qubes-gpg-client -l 'personal-cipher-preferences' -d 'Set the list of personal cipher preferences to the specified string'
complete -c qubes-gpg-client -l 'personal-compress-preferences' -d 'Set the list of personal compression preferences to the specified string'
complete -c qubes-gpg-client -l 'personal-digest-preferences' -d 'Set the list of personal digest preferences to the specified string'
...
complete -c qubes-gpg-client -l 's2k-count' -d 'Specify how many times the passphrase mangling for symmetric encryption is repeated'
complete -c qubes-gpg-client -l 's2k-mode' -d 'Selects how passphrases are mangled'
complete -c qubes-gpg-client -l 'status-fd' -d 'Write special status strings to the specified file descriptor'
complete -c qubes-gpg-client -l 'store' -d 'Store only (make a simple RFC1991 packet)'
complete -c qubes-gpg-client -l 'trust-model' -d 'Specify trust model'
