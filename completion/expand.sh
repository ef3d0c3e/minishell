...
complete -c expand -s 't' -l 'tabs' -d 'have tabs NUMBER characters apart, not 8'
complete -c expand -s 't' -l 'tabs' -d 'use comma separated list of explicit tab positions'
