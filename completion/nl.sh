...
complete -c nl -s 'd' -l 'section-delimiter' -d 'use for separating logical pages'
...
complete -c nl -s 'n' -l 'number-format' -d 'left justified, no leading zeroes'
complete -c nl -s 'n' -l 'number-format' -d 'right justified, no leading zeroes'
complete -c nl -s 'n' -l 'number-format' -d 'right justified, leading zeroes'
...
complete -c nl -s 'v' -l 'starting-line-number' -d 'first line number on each logical page'
