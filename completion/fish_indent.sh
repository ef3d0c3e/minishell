...
complete -c fish_indent -s 'd' -l 'debug' -d 'Enable debug at specified verbosity level'
complete -c fish_indent -s 'o' -l 'debug-output' -d 'Where to direct debug output to'
complete -c fish_indent -s 'D' -l 'debug-stack-frames' -d 'Specify how many stack frames to display in debug messages'
