complete -c pydf -d 'Report colourised filesystem disk space usage'
...
complete -c pydf -s 'b' -l 'block-size' -d 'use BLOCKSIZE-byte blocks'
...
complete -c pydf -l 'mounts' -d 'file to get mount information from'
