...
complete -c pstree -s 'H' -l 'highlight-pid' -d 'highlight this process and its ancestors'
...
complete -c pstree -s 'N' -l 'ns-sort' -d 'sort by namespace type'
...
complete -c pstree -d 'PID'
complete -c pstree -d 'USER'
