complete -c VBoxSDL -l 'startvm' -d 'Set virtual machine to start'
complete -c VBoxSDL -l 'separate' -d 'Run separate VM process or attach to a running VM'
complete -c VBoxSDL -l 'hda' -d 'Set temporary first hard disk'
complete -c VBoxSDL -l 'fda' -d 'Set temporary first floppy disk'
complete -c VBoxSDL -l 'cdrom' -d 'Set temporary CDROM/DVD'
complete -c VBoxSDL -l 'boot' -d 'Set temporary boot device'
complete -c VBoxSDL -l 'memory' -d 'Set temporary memory size in MB'
complete -c VBoxSDL -l 'vram' -d 'Set temporary video memory size in MB'
...
complete -c VBoxSDL -l 'fixedmode' -d 'Use fixed SDL video mode with given width height and bit/pixel'
...
complete -c VBoxSDL -l 'hostkey' -d 'Set host key to values obtained using --detecthostkey'
...
complete -c VBoxSDL -l 'settingspw' -d 'Specify settings password'
complete -c VBoxSDL -l 'settingspwfile' -d 'Specify file containing setting password'
