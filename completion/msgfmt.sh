complete -c msgfmt -s 'D' -l 'directory' -d 'Add specified directory to list for input files search'
complete -c msgfmt -s 'j' -l 'java' -d 'Generate a Java ResourceBundle class'
complete -c msgfmt -l 'java2' -d 'Like --java, and assume Java2 (JDK 1.2 or higher)'
complete -c msgfmt -l 'csharp' -d 'Generate a .NET .dll file'
complete -c msgfmt -l 'csharp-resources' -d 'Generate a .NET .resources file'
complete -c msgfmt -l 'tcl' -d 'Generate a tcl/msgcat .msg file'
complete -c msgfmt -l 'qt' -d 'Generate a Qt .qm file'
...
complete -c msgfmt -s 'd' -d 'Base directory for output'
...
complete -c msgfmt -s 'a' -l 'alignment' -d 'Alignment'
