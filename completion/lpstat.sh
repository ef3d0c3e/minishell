...
complete -c lpstat -s 'W' -d 'Specify which jobs to show'
complete -c lpstat -s 'a' -d 'Shows accepting state of selected printer queues'
complete -c lpstat -s 'c' -d 'Shows printer classes and the printers that belong to them'
...
complete -c lpstat -s 'o' -d 'Shows jobs queue on the specified destinations'
complete -c lpstat -s 'p' -d 'Shows printers and if they are enabled for printing'
...
complete -c lpstat -s 'v' -d 'Shows printers and what device they are attached to'
