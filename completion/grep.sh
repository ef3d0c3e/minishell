...
complete -c grep -l 'binary-files' -d 'Assume data type for binary files'
complete -c grep -l 'colour' -d 'Colour output'
complete -c grep -l 'color' -d 'Color output'
complete -c grep -s 'c' -l 'count' -d 'Only print number of matches'
complete -c grep -s 'D' -l 'devices' -d 'Action for devices'
complete -c grep -s 'd' -l 'directories' -d 'Action for directories'
...
complete -c grep -l 'group-separator' -d 'Set a group separator'
