complete -c mocha -l 'help' -s 'h' -d 'Show help'
...
complete -c mocha -s 'R' -l 'reporter' -d 'specify the reporter to use'
...
complete -c mocha -s 'g' -l 'grep' -d 'only run tests matching <pattern>'
complete -c mocha -s 'f' -l 'fgrep' -d 'only run tests containing <string>'
complete -c mocha -s 'g' -l 'expose-gc' -d 'expose gc extension'
complete -c mocha -s 'i' -l 'invert' -d 'inverts --grep and --fgrep matches'
complete -c mocha -s 'r' -l 'require' -d 'require the given module'
complete -c mocha -s 's' -l 'slow' -d '"slow" test threshold in milliseconds [75]'
complete -c mocha -s 't' -l 'timeout' -d 'set test-case timeout in milliseconds [2000]'
complete -c mocha -s 'u' -l 'ui' -d 'specify user-interface (bdd|tdd|qunit|exports)'
...
complete -c mocha -l 'compilers' -d 'use the given module(s) to compile files'
complete -c mocha -l 'debug-brk' -d 'enable node'"'"'s debugger breaking on thefirst line'
complete -c mocha -l 'globals' -d 'allow the given comma-delimited global[names]'
