...
complete -c sort -s 'o' -l 'output' -d 'Write to file'
complete -c sort -s 's' -l 'stable' -d 'Stabilize sort'
complete -c sort -s 'S' -l 'buffer-size' -d 'Set memory buffer size'
complete -c sort -s 't' -l 'field-separator' -d 'Field separator'
complete -c sort -s 'T' -l 'temporary-directory' -d 'Set temporary directory'
