complete -c fsharpc -l 'out:' -d 'Name of the output file'
complete -c fsharpc -l 'target:exe' -d 'Build a console executable'
complete -c fsharpc -l 'target:winexe' -d 'Build a Windows executable'
complete -c fsharpc -l 'target:library' -d 'Build a library'
complete -c fsharpc -l 'target:module' -d 'Build a module that can be added to another assembly'
...
complete -c fsharpc -l 'reference:' -d 'Reference an assembly'
...
complete -c fsharpc -s 'g' -l 'debug' -l 'debug+' -d 'Emit debug information'
complete -c fsharpc -l 'debug-' -d 'Disable --debug'
complete -c fsharpc -s 'O' -l 'optimize' -l 'optimize+' -d 'Enable optimizations'
complete -c fsharpc -l 'optimize-' -d 'Disable --optimize'
...
complete -c fsharpc -l 'define:' -d 'Define conditional compilation symbols'
...
complete -c fsharpc -l 'lib:' -d 'Specify a directory for include path for resolving source files and assemblies'
