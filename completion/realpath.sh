...
complete -c realpath -l 'relative-to' -d 'print the resolved path relative to FILE'
complete -c realpath -l 'relative-base' -d 'print absolute paths unless paths below FILE'
