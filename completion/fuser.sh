...
complete -c fuser -s 'm' -l 'mount' -d 'All processes accessing files on that file system are listed'
...
complete -c fuser -s 'n' -l 'namespace' -d 'Slect a different namespace'
