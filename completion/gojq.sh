...
complete -c gojq -l 'indent' -d 'Number of spaces for indentation'
...
complete -c gojq -s 'f' -l 'from-file' -d 'Load query from file'
complete -c gojq -s 'L' -d 'Directory to search modules from'
complete -c gojq -l 'arg' -d 'Set variable to string value'
complete -c gojq -l 'argjson' -d 'Set variable to JSON value'
complete -c gojq -l 'slurpfile' -d 'Set variable to the JSON contents of the file'
complete -c gojq -l 'rawfile' -d 'Set variable to the contents of the file'
